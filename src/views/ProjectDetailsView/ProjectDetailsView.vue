...
function showDeletionConfirmationModal() {
  deletionConfirmationMessage.value =
    'Are you sure you want to delete the project? All income data of this project will be removed.';
...
<template>
  <div class="content-wrapper">
    ...
    <p class="line-item-explanation">
      All fields must be filled. Whenever you want to remove a line item, click 'X'.
    </p>
    <LineItemsTable :projectID="projectID" />
    <div class="button-container">
      <BaseButton
        @buttonClicked="showStatusConfirmationModal"
        buttonStyle="filled-green"
        :disabled="false"
        v-if="!projectManager.getProjectByID(projectID).completed"
        >Mark project as completed</BaseButton
      >
      <BaseButton
        @buttonClicked="showStatusConfirmationModal"
        buttonStyle="filled-green"
        :disabled="false"
        v-if="projectManager.getProjectByID(projectID).completed"
        >Mark project as ongoing</BaseButton
      >
      <BaseButton
        @buttonClicked="showDeletionConfirmationModal"
        buttonStyle="filled-green"
        :disabled="false"
        >Delete project</BaseButton
      >
      <BaseButton @buttonClicked="handleClose" buttonStyle="filled" :disabled="false"
        >Close</BaseButton
      >
    </div>
    <ConfirmationModal
      v-if="isStatusConfirmationModalVisible"
      title="Please confirm"
      @cancel="isStatusConfirmationModalVisible = false"
      @confirm="toggleProjectStatus"
    >
    ...
    <ConfirmationModal
      ...
      title="Please confirm"
      @cancel="isDeletionConfirmationModalVisible = false"
      @confirm="handleDeletionOfProject"
    >
