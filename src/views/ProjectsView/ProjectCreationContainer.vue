...
<template>
  <div class="container-item-creation container">
    <div class="subcontainer-text-button">
      ...
      <BaseButton @buttonClicked="toggleProjectCreationModal" buttonStyle="filled" :disabled="false"
        >Add new</BaseButton
      >
    </div>
  ...
  <AlertMessage
    ...
    >You can now add more details to each of your projects below.</AlertMessage
  >
  <ProjectFormModal
    :visible="isProjectCreationModalVisible"
    @close="toggleProjectCreationModal"
    @projectCreated="handleSuccessAlert"
  />
</template>
