    ...
    <div class="modal-content container">
      <div class="modal-content-wrapper">
        ...
        <FormProjectInfo
          ...
          @projectDescriptionChanged="updateProjectDescription"
        />
        ...
        <div class="button-wrapper">
          <BaseButton
            class="first-button"
            buttonStyle="empty"
            :disabled="!areAllRequiredInputsProvided"
            @buttonClicked="handleProjectAddition"
            >Save</BaseButton
          >
          <BaseButton buttonStyle="empty" :disabled="false" @buttonClicked="handleClose"
            >Cancel</BaseButton
          >
        </div>
      </div>
