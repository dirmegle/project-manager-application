...
import useProjectManagerStore, {
  type Project
} from '@/stores/projectManagerStore/projectManagerStore';
...
<template>
  ...
  <AlertMessage
    v-if="!fromIsLessThanTo"
    color="amber"
    icon="$warning"
    title="'From' date is bigger than 'To' date"
    >Please select correct dates</AlertMessage
  >
</template>
